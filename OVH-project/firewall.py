...
ip6_rules = [
            ...
            # (telstra3,as1_r15)
            Rule('-A INPUT --src babe:1:11:1600::/64 -d 2001:1:11:1401::/64 -j ACCEPT'),
            # (ntt3,as1_r14)
            Rule('-A INPUT --src babe:1:11:1900::/64 -d 2001:1:11:1301::/64 -j ACCEPT'),
            # (equinix2,as1_r14)
            Rule('-A INPUT --src babe:1:11:1800::/64 -d 2001:1:11:1302::/64 -j ACCEPT'),
            # (telstra1,as1_bb1)
